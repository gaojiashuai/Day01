...
public class gaiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        String jieduan1=jieduan.getText().toString();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button:
                yesterdayBeanDao.update(yesterdayBean);
